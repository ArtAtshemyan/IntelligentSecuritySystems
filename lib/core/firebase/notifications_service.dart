...
//
  ...
  Future<void> showNotification(RemoteMessage message) async {
    AndroidNotificationChannel channel = AndroidNotificationChannel(
      ...
      showBadge: true,
      playSound: true,
      // sound: const RawResourceAndroidNotificationSound('jet sons_doorbell'),
    );
    ...
    AndroidNotificationDetails(
        ...
        ticker: 'ticker',
        sound: channel.sound
      //     sound: RawResourceAndroidNotificationSound('jet sons_doorbell')
      //  icon: largeIconPath
    );
  ...
  Future<void> handleMessage(
    ...
    //   context,
    //   MaterialPageRoute(
    //     builder: (context) => VerificationPage(signupReq: signupReq),
    //   ),
    // );
